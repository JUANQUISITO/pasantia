...
function openModal() {
    ...
    document.querySelector('#exampleModalLabel').innerHTML = "Nueva Solicitud";
...
function fntSolicitud_antes(idEstudiante)
{
    ...
    estudianteSolicitud.onsubmit = function(e)
    {
        console.log("crear solicitud");
        e.preventDefault();
        var request = new XMLHttpRequest();
        
        var ajaxUrl = base_url + 'SolicitudPasantias/insertar/'+ idEstudiante;
        
        var formElement = document.querySelector("#estudianteSolicitud");
        var formData = new FormData(formElement);
        request.open("POST",ajaxUrl,true);
        request.send(formData);
        console.log(formData);
        
        var strData = $("#estudianteSolicitud").serialize();
        request.open("POST", ajaxUrl, true);
        request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        request.send(strData);
        request.onreadystatechange = function () {
