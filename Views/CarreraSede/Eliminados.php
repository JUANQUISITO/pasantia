...
<div class="card">
    <div class="card-header card-header-primary">
        <h3>CARRERAS-SEDES ELIMINADOS</h3>
    </div>
    <div class="card-body">
        <div  >
            <section>
                        ...
                        <div class="col-lg-12 mt-2">
                            <div class="row">
                                <div class="col-lg-6 mb-2">
                                    <a class="btn btn-primary" href="<?php echo base_url(); ?>CarreraSede"><i class="fas fa-user-slash"></i> Regresar</a>
                                </div>
                                    ...
                                    <table class="table table-hover table-bordered" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="<?php echo base_url() ?>CarreraSede/reingresar?id=<?php echo $cl['id_carrera_sede']; ?>" method="post" class="d-inline confirmar">
