...
<div class="card">
    <div class="card-header card-header-primary">
        <h3 style="color:blue;"><strong>EMPRESAS ELIMINADAS</strong></h3>
    </div>
    <div class="card-body">
        <div  >
            <section>
                        ...
                        <div class="col-lg-12 mt-2">
                            <div class="row">
                                <div class="col-lg-6 mb-2">
                                    ...
                                    <a class="btn btn-primary" href="<?php echo base_url(); ?>Empresas/Listar"><i class="fas fa-user-slash"></i> Regresar</a>
                                </div>
                                <div class="col-lg-6">
