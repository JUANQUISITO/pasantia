            ...
            <form method="post" id="formEmpresa" action="<?php echo base_url(); ?>Empresas/insertar" autocomplete="off">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input style="border-color: blue;" id="nombre" class="form-control"  minlength="4" maxlength="100"  type="text" name="NombreEmpresa" placeholder="Nombre Empresa" required>
                    </div>

                    <div class="form-group">
                        <label for="areaEmpresa">Area </label>
                        <input style="border-color: blue;" id="areaEmpresa" class="form-control"  minlength="6" maxlength="50" type="text" name="areaEmpresa" placeholder="Area Empresa" required>
                    </div>

                    <div class="form-group">
                        <label for="nit">NIT</label>
                        <input style="border-color: blue;"  minlength="12" maxlength="12"  id="nit" class="form-control" type="number" name="nroNit" placeholder="Nro Nit" required oninvalid="setCustomValidity('Se necesitan 12 digitos ')"  oninput="setCustomValidity('')">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input style="border-color: blue;" id="cargo" minlength="7" maxlength="60" class="form-control" type="text" name="cargo" placeholder="Cargo de la Persona de Contacto" required>
                    </div>
                            
                    <div class="form-group">
                        <label for="telefContacto">Telefono Contacto</label>
                        <input style="border-color: blue;" id="telefContacto" minlength="7" maxlength="8"  class="form-control" type="text" name="telefContacto" placeholder="Telefono Persona de Contacto" required oninvalid="setCustomValidity('Se necesitan 7 u 8 digitos ')"  oninput="setCustomValidity('')">
                    </div>
