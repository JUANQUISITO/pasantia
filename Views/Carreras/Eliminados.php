                        ...
                        <div class="col-lg-12 mt-2">
                            <div class="row">
                                <div class="col-lg-6 mb-2">
                                    ...
                                    <a class="btn btn-primary" href="<?php echo base_url(); ?>Carreras"><i class="fas fa-user-slash"></i> Regresar</a>
                                </div>
                                        ...
                                        <tbody>
                                            <?php $c=0; foreach ($data as $cl) { $c++; ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="<?php echo base_url() ?>Carreras/reingresar?id=<?php echo $cl['id_carrera']; ?>" method="post" class="d-inline confirmar">
